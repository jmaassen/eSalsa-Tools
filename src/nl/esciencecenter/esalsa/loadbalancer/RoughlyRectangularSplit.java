...
public class RoughlyRectangularSplit extends Split {
     ...
     * 
     * @param work
     *            the amount work to split.
     * @param subsets
     *            the number of subsets to split into.
     ...
     * 
     * @param work
     *            the amount of work to split
     * @param slices
     *            an array describing the relative amount of work for each row.
     * @param totalParts
     *            the total number of subsets to create.
     ...
     * 
     * @param parts
     *            the number of slots to divide over.
     * @param subParts
     *            the minimal number of subParts in each slot.
     * @param leftOver
     *            the leftOver parts that need to be divided evenly over the slots.
     ...
     * </ul>
     * <p>
     * Based on the initial estimation, the division onto subsets is then made by splitting the set first row wise and then column
     * wise (if the set is wider than it is height), or first column wise and then row wise (if the set is higher than it is
     * wide).
     * <p>
